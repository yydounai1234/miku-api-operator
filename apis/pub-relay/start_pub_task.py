...
def test_start_pub_task(task_id):
    """
    测试开始（启动）pub 转推任务接口
    ...
    path = "/tasks/{}/start".format(task_id)
...
if __name__ == "__main__":
    ...
    print("Testing start pub task API with task_id: {}".format(task_id))
    response = test_start_pub_task(task_id)
