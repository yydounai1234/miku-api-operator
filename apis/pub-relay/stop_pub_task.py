...
def test_stop_pub_task(task_id):
    """
    测试停止（终止）pub 转推任务接口
    ...
    path = "/tasks/{}/stop".format(task_id)
...
if __name__ == "__main__":
    ...
    print("Testing stop pub task API with task_id: {}".format(task_id))
    response = test_stop_pub_task(task_id)
