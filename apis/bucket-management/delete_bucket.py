...
if __name__ == "__main__":
    # 测试删除空间，替换 "test-bucket-name" 为你想要删除的空间名称
    bucket_name = "test-bucket-name"
    print("Testing delete bucket API with bucket name: {}".format(bucket_name))
    response = test_delete_bucket(bucket_name)
