...
def test_list_downstream_domains(bucket_name):
    """
    测试列举下行域名接口
...
if __name__ == "__main__":
    ...
    print("Testing list downstream domains API with bucket name: {}".format(bucket_name))
    
    response = test_list_downstream_domains(bucket_name)
